...
class CollectionsTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFilter($_)
    {
        ...
        $this->assertEquals(array(2, 4, 6), $_::toArray($evens), 'selected each even number');

        $evens = $_::select(array(1, 2, 3, 4, 5, 6), function($num) { return $num % 2 == 0; });
        $this->assertEquals(array(2, 4, 6), $_::toArray($evens), 'aliased as "select"');
    }
    ...
    public function testReject($_)
    {
        ...
        $this->assertEquals(array(1, 3, 5), $_::toArray($odds), 'rejected each even number');
    }
    ...
    public function testToArray($_)
    {
        ...
        $this->assertEquals(array(1, 2, 3), $_::toArray($numbers), 'object flattened into array');
    }
